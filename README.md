...
* Isolation of all source manipulations to a working directory (`build_hatchery`)
...
`workdir` | `build_hatchery` | Hatchery uses a working directory. Set its relative or absolute path here. Passed to [`workdir`](https://pypi.python.org/pypi/workdir) library.
